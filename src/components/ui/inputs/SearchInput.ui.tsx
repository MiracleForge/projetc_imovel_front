...
export default function SearchInput() {
 return (
  <div className="w-full border-2 border-neutral-300 focus-within:border-black px-3 py-1.5 duration-200 focus-within:ring focus-within:ring-black/20 rounded-lg">
