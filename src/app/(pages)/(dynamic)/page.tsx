...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-white px-2 py-3 lg:space-y-12">

      <div className="w-full flex lg:justify-center space-x-3 flex-nowrap overflow-x-auto no-scrollbar px-1">
